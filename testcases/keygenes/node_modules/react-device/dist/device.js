...
var getComputedFontSize = function getComputedFontSize() {
...
var Device = function (_Component) {
  ...
  _createClass(Device, null, [{
    ...
    value: function _buildDeviceInfo() {
      ...
      if (isClientSide()) {
        ...
        var fontSize = getComputedFontSize();
  ...
  function Device(props) {
    ...
    if (!Device._debouncedChange) {
      Device._debouncedChange = (0, _lodash2.default)(Device._onChange, Device.DEBOUNCE_TIME);
    }
